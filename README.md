...
- Сохранять данные в firebase (done)
- Нельзя ручками вводить уровень, потому что если ввести 1 - все сломается (done)
- Все ломается, если ввести слишком много карточек или слишком маленький уровень (done)
